execute if score dummy mainquest_start matches 1 if score dummy st1_main1_clear matches 0 run scriptevent q:quest_update -1
...
execute if score dummy st1_keyquest_state matches 2.. run scoreboard players set dummy st1_keyquest_clear 1
execute unless score dummy st1_keyquest_state matches 2.. run scriptevent q:quest_update -4
execute unless score dummy st1_keyquest_state matches 2.. run scoreboard players set dummy st1_keyquest_clear 0
execute if score dummy st1_keyquest_clear matches 1 run function stage1/Key_Quest/on_clear_keyquest_stage1

execute if score dummy stage matches 1 if score dummy st1_expansionquest_clear matches 1 run function stage1/on_clear_stage1
